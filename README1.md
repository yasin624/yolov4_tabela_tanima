...
#### Resim dosyalarını  <font  color="pink "> resim_kırpma() </font> fonksiyonu ile resimleri ortadan ikiye ayırdık bu sayede verileri bozmadan ,ayrıntıları fazla kaçırmadan objenin bulunduğu bölgeyi aldım.
...
#### Etiketleri kaydetme den önce boxx değerlerini <font  color="pink "> x y w h </font> formatına dönuştürmek için <font  color="pink "> yolov_format() </font> fonksiyonundan  yararlandım.Veriler yolo modeline  aktarılmaya hazır hale getirildi.
